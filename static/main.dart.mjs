...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1344: a => a.length,
      _1345: (a, l) => a.length = l,
      _1346: (a, i) => a[i],
      _1347: (a, i, v) => a[i] = v,
      _1348: (a, t) => a.concat(t),
      _1349: o => {
      ...
      _1425: (x0,x1,x2) => x0.open(x1,x2),
      _1426: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      _1427: x0 => x0.abort(),
      _1428: (x0,x1) => x0.send(x1),
      _1429: x0 => x0.send(),
      _1430: x0 => x0.getAllResponseHeaders(),
      _1431: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1432: (x0,x1,x2) => x0.fetch(x1,x2),
      ...
      _1625: x0 => x0.readyState,
      _1627: (x0,x1) => { x0.timeout = x1 },
      _1629: (x0,x1) => { x0.withCredentials = x1 },
      _1630: x0 => x0.upload,
      _1631: x0 => x0.responseURL,
      _1632: x0 => x0.status,
      _1633: x0 => x0.statusText,
      _1635: (x0,x1) => { x0.responseType = x1 },
