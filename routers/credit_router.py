...
@router.get("/credit")
async def credit(amount: str, reason: str, category: str, area: str, user_id: int = Depends(get_current_user)):
    ...
    cursor.execute(
        ...
        """,
        (combined_id, reason, amount, category, "credit", area, current_date)
    )
